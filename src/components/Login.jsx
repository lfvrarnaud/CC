...
const Login = () => {
  ...
  return (
    <form
      ...
      className="flex flex_col form_connexion"
    >
      <h2>Connexion</h2>
      <div className="block_form_connexion">
        <input
          placeholder="Pseudo"
          className="form_input input_connexion"
          {...register("username")}
        />
        <input
        ...
        <button className="button button_connexion button_blue">
          Connexion
        </button>
    </form>
  );
